...
class ADChromePullToRefreshView: UIView {
    ...
    func setUpConstraints() {
        ...
        let highlightHorizontalConstraints: NSArray = NSLayoutConstraint.constraintsWithVisualFormat("H:|[highlightView]|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewsDictionary)
        self.addConstraints(highlightHorizontalConstraints as! [NSLayoutConstraint])
