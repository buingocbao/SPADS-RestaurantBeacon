...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    ...
    if (self) {
        ...
        self.textfieldPlaceholderTextColor = [UIColor whiteColor];
...
- (void)addPlaceholderTextToCellTextField {
    self.cellTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"Search" attributes:@{NSForegroundColorAttributeName: self.textfieldPlaceholderTextColor}];
}
