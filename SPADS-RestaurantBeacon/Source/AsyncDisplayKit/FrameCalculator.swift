...
class FrameCalculator {
  ...
  class func frameForFeatureImage(featureImageSize featureImageSize: CGSize, containerFrameWidth: CGFloat) -> CGRect {
    _ = aspectSizeForWidth(containerFrameWidth, originalSize: featureImageSize)
    return CGRect(x: 0, y: 0, width: 100, height: 100) //imageFrameSize.width //imageFrameSize.height
  }
