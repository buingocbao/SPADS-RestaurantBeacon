...
public class SAParallaxViewController: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        NSLayoutConstraint.applyAutoLayout(view, target: collectionView, top: 54.0+44, left: 0.0, right: 0.0, bottom: 0.0, height: nil, width: nil)
...
extension SAParallaxViewController: UICollectionViewDataSource {
    public func collectionView(collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        if let restaurantNum = defaults.stringForKey("RestaurantNum") {
            return Int(restaurantNum)!
        }
        return 0
    }
