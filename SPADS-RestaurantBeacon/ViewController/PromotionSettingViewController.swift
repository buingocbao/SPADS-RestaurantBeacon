//
//  PromotionSettingViewController.swift
...
class PromotionSettingViewController: UIViewController, UIViewControllerTransitioningDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if let controller = segue.destinationViewController as? AddPromotionViewController {
            controller.transitioningDelegate = self
            controller.modalPresentationStyle = .Custom
            controller.lbMainText = "Add Promotion"
        }
    }
